...
<div class="modal fade" id="addCopsModal" tabindex="-1" role="dialog" aria-labelledby="addDrawingModal"
    aria-hidden="true">
                        ...
                        <form class="user" action="{{ route('pmd.content.create') }}" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="content_path" name="content_path"
                                    value="Rail / Drawing / {{$scopes->carryProject_name}}" readonly>
                            </div>
                            ...
                            <input type="hidden" class="form-control" id="content_category" name="content_category" value="Carry-over Project Scope">
