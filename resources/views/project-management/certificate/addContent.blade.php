<!-- Modal Create Cert Form-->
<div class="modal fade" id="addCertModal" tabindex="-1" role="dialog" aria-labelledby="addDrawingModal"
    aria-hidden="true">
                        ...
                        <form class="user" action="{{ route('pmd.content.create') }}" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="content_path" name="content_path"
                                    value="Rail / Drawing / {{$certs->cert_name}}" readonly>
                            </div>
                            ...
                            <input type="hidden" class="form-control" id="cert_id" name="cert_id"
                                    value="{{ $certs->cert_id }}">
                            ...
                            <input type="hidden" class="form-control" id="content_category" name="content_category" value="Certificate">
