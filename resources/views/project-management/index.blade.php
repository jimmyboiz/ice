        ...
        <div class="col-xl-12 mb-4">
            <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body text-center"> --}}
                    <h1 class="text-gray-900 font-weight-bold mb-4">Info Category Putrajaya Line</h1>
                {{-- </div>
            </div>
        </div>
    </div> --}}
            ...
            <div class="card text-center">
                <div class="card-header">
                    <a href="{{ route('pmd.report') }}">
                        <img src="https://cdn-icons-png.flaticon.com/512/235/235253.png" class="img-fluid" width="150"
                            height="30">
                </div>
                <div class="card-body">
            ...
            <div class="card text-center">
                <div class="card-header">
                    <a href="{{ route('pmd.agreement') }}">
                        <img src="https://cdn-icons-png.flaticon.com/512/5165/5165921.png" class="img-fluid" width="150"
                            height="30">
                </div>
                <div class="card-body">
            ...
            <div class="card text-center">
                <div class="card-header">
                    <a href="{{ route('pmd.event') }}">
                        <img src="https://cdn-icons-png.flaticon.com/512/2403/2403797.png" class="img-fluid" width="150"
                            height="30">
                </div>
                <div class="card-body">
            ...
            <div class="card text-center">
                <div class="card-header">
                    <a href="{{ route('pmd.cops') }}">
                        <img src="https://cdn-icons-png.flaticon.com/512/390/390077.png" class="img-fluid" width="150"
                            height="30">
                </div>
                <div class="card-body">
            ...
            <div class="card text-center">
                <div class="card-header">
                    <a href="{{ route('pmd.software') }}">
                        <img src="https://cdn-icons-png.flaticon.com/512/5741/5741483.png" class="img-fluid" width="150"
                            height="30">
                </div>
                <div class="card-body">
            ...
            <div class="card text-center">
                <div class="card-header">
                    <a href="{{ route('pmd.environmental') }}">
                        <img src="https://cdn-icons-png.flaticon.com/512/2926/2926961.png" class="img-fluid" width="150"
                            height="30">
                </div>
                <div class="card-body">
            ...
            <div class="card text-center">
                <div class="card-header">
                    <a href="{{ route('pmd.other') }}">
                        <img src="https://cdn-icons-png.flaticon.com/512/3357/3357334.png" class="img-fluid" width="150"
                            height="30">
                </div>
                <div class="card-body">
