...
<div class="modal fade" id="addEnvironmental" tabindex="-1" role="dialog" aria-labelledby="demoModalLabel"
aria-hidden="true">
<div class="modal-dialog modal-lg" style="min-width:50%;" role="document">
    <div class="modal-content">
        <div class="modal-header">
            <h5 class="modal-title" id="demoModalLabel">Create New Environmental Document</h5>
        ...
        <div class="modal-body">
            <div class="card shadow col-xl-12  mb-4">
                <div class="card-body">
                    <form class="user" action="{{ route('pmd.storeEnvironment') }}" method="POST"
                        ...
                        <div class="form-group">
                            ...
                            <textarea rows="5" class="form-control" id="environment_desc" name="environment_desc"></textarea>
                        </div>
                        <div class="form-group">
