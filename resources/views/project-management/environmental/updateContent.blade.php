<div class="modal fade" id="updateEnvironment{{ $content->content_id }}" tabindex="-1" role="dialog"
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <select class="form-control" id="project_id" name="project_id" required>
                                        ...
                                        <option value="{{ $content->project_id }}" selected>{{ $project->project_name }}</option>
                                        @else
