<div class="modal fade" id="demoModal{{ $subcontent->content_id }}" tabindex="-1" role="dialog"
                        ...
                        <form method="POST" action="{{ route('pmd.content.update', [$subcontent->content_id]) }}">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('content_link') is-invalid @enderror"
                                    id="content_link" name="content_link"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="content_path" name="content_path"
                                    value="{{ $subcontent->content_path }}" readonly>
                            </div>
                            <div class="form-group row">
                                    ...
                                    <select class="form-control" id="project_id" name="project_id" required>
                                        @foreach ($projects as $project)
                                            @if ($subcontent->project_id == $project->project_id)
                                                <option value="{{ $subcontent->project_id }}" selected>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" class="form-control"id="keyword" name="keyword"
                                        value="{{ $subcontent->keyword }}"required>
                                </div>
                            </div>
                            <div class="form-group">
                                <input type="hidden" class="form-control" id="usr_update" name="usr_update"
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <select class="form-control @error('is_active') is-invalid @enderror" id="is_active"
                                        ...
                                        @if ($subcontent->is_active == 'Y')
                                            <option value="{{ $subcontent->is_active }}" selected>Active</option>
                                            <option value="N">Inactive</option>
                                        @elseif($subcontent->is_active == 'N')
                                            <option value="{{ $subcontent->is_active }}" selected>Inactive</option>
