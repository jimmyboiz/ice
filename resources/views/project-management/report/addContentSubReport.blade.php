...
<div class="modal fade" id="addContentSubReportModal{{ $subgroup->subgroup_id }}" tabindex="-1" role="dialog"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="card shadow col-xl-12  mb-4">
                    <div class="card-body">
                        <form class="user" action="{{ route('pmd.storeSubContent') }}" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="content_path" name="content_path"
                                    value="Rail / Report / {{ $viewreports->report_name }} / {{ $subgroup->subgroup_name }}"
                                    readonly>
                            </div>
