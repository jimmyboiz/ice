<div class="modal fade" id="updateContent{{ $sevenday->item_id }}" tabindex="-1" role="dialog"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="card shadow col-xl-12  mb-4">
                    <div class="card-body">
                        <form method="POST" action="{{ route('pmd.item.update', [$sevenday->item_id]) }}">
                            @csrf
                            <div class="form-group">
                                ...
                                <textarea rows="2" class="form-control @error('item_desc') is-invalid @enderror" id="item_desc" name="item_desc"
                                    required>{{ $sevenday->item_desc }}</textarea>
                                @error('item_desc')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('item_vendor') is-invalid @enderror"
                                    id="item_vendor" name="item_vendor" value="{{ $sevenday->item_vendor }}">
                                @error('item_vendor')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" class="form-control @error('item_PIC') is-invalid @enderror"
                                        id="item_PIC" name="item_PIC" value="{{ $sevenday->item_PIC }}">
                                    @error('item_PIC')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="email"
                                        ...
                                        id="item_PIC_email" name="item_PIC_email" value="{{ $sevenday->item_PIC_email }}">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-6">
                                    ...
                                    <input type="date" class="form-control" id="start_date" name="start_date"
                                        value="{{ $sevenday->start_date }}">
                                </div>
                                <div class="col-sm-6">
                                    <label class="label">Expiry Date</label>
                                    <input type="date" class="form-control" id="expiry_date" name="expiry_date"
                                        value="{{ $sevenday->expiry_date }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-6">
                                    ...
                                    <select class="form-control" id="project_id" name="project_id" required>
                                        ...
                                        @if($sevenday->project_id == $project->project_id)
                                        <option value="{{ $sevenday->project_id }}" selected>{{ $project->project_name }}</option>
                                        @else
