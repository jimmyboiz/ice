<div class="modal fade" id="updateContent{{ $thirtyday->item_id }}" tabindex="-1" role="dialog"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="card shadow col-xl-12  mb-4">
                    <div class="card-body">
                        <form method="POST" action="{{ route('pmd.item.update', [$thirtyday->item_id]) }}">
                            @csrf
                            <div class="form-group">
                                ...
                                <textarea rows="2" class="form-control @error('item_desc') is-invalid @enderror" id="item_desc" name="item_desc"
                                    required>{{ $thirtyday->item_desc }}</textarea>
                                @error('item_desc')
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control @error('item_vendor') is-invalid @enderror"
                                    id="item_vendor" name="item_vendor" value="{{ $thirtyday->item_vendor }}">
                                @error('item_vendor')
                                    <span class="invalid-feedback" role="alert">
                                        <strong>{{ $message }}</strong>
                                    </span>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" class="form-control @error('item_PIC') is-invalid @enderror"
                                        id="item_PIC" name="item_PIC" value="{{ $thirtyday->item_PIC }}">
                                    @error('item_PIC')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="email"
                                        ...
                                        id="item_PIC_email" name="item_PIC_email" value="{{ $thirtyday->item_PIC_email }}">
                            ...
                            <div class="form-group row">
                                <div class="col-sm-6">
                                    ...
                                    <input type="date" class="form-control" id="start_date" name="start_date"
                                        value="{{ $thirtyday->start_date }}">
                                </div>
                                <div class="col-sm-6">
                                    <label class="label">Expiry Date</label>
                                    <input type="date" class="form-control" id="expiry_date" name="expiry_date"
                                        value="{{ $thirtyday->expiry_date }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group row">
                                <div class="col-sm-6">
                                    ...
                                    <select class="form-control" id="project_id" name="project_id" required>
                                        ...
                                        @if($thirtyday->project_id == $project->project_id)
                                        <option value="{{ $thirtyday->project_id }}" selected>{{ $project->project_name }}</option>
                                        @else
