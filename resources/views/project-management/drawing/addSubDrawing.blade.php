<!-- Modal Create Drawing Form-->
<div class="modal fade" id="addContentSubDrawingModal{{ $subgroup->subgroup_id }}" tabindex="-1" role="dialog"
    aria-labelledby="addContentSubDrawingModal" aria-hidden="true">
    <div class="modal-dialog modal-lg" style="min-width:50%;" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addContentSubDrawingModalLabel">Add Document</h5>
            ...
            <div class="modal-body">
                <div class="card shadow col-xl-12  mb-4">
                    <div class="card-body">
                        <form class="user" action="{{ route('pmd.storeSubDrawingContent') }}" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="content_path" name="content_path"
                                    value="Rail / Drawing / {{$drawings->drawing_name}}" readonly>
                            </div>
                            ...
                            <input type="hidden" class="form-control" id="content_category" name="content_category" value="Drawing">
