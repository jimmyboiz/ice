<!-- Modal Create Drawing Group Form-->
<div class="modal fade" id="addDrawingGroupModal" tabindex="-1" role="dialog" aria-labelledby="addDrawingGroupModal"
    aria-hidden="true">
    <div class="modal-dialog modal-lg" style="min-width:50%;" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addDrawingGroupModalLabel">Add Drawing</h5>
            ...
            <div class="modal-body">
                <div class="card shadow col-xl-12  mb-4">
                    <div class="card-body">
                        <form class="user" action="{{ route('pmd.storeDrawingGroup') }}" method="POST"
                            enctype="multipart/form-data">
                            @csrf
                            <div class="form-group row">
                                <div class="col-sm-6">
                                    <label class="label">Group Name</label>
                                    <input type="text" class="form-control" id="subgroup_name" name="subgroup_name"
                                        required>
                                </div>
...
<!-- Modal Create Drawing Group Form End-->
