<!-- Modal Create Certificate Form-->
<div class="modal fade" id="softwareModal" tabindex="-1" role="dialog" aria-labelledby="demoModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" style="min-width:50%;" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="demoModalLabel">Create New Software</h5>
            ...
            <div class="modal-body">
                <div class="card shadow col-xl-12  mb-4">
                    <div class="card-body">
                        <form class="user" action="{{ route('pmd.storeSoftware') }}" method="POST"
                            ...
                            <div class="form-group">
                                <label class="label">Software Description</label>
                                <textarea rows="5" class="form-control" id="software_desc" name="software_desc"></textarea>
                            </div>
