<!-- Modal Edit Other Records Form-->
<div class="modal fade" id="editOtherModal{{ $content->content_id }}" tabindex="-1" role="dialog"
    aria-labelledby="editOtherModal" aria-hidden="true">
    <div class="modal-dialog modal-lg" style="min-width:50%;" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="editOtherModal">Edit Document</h5>
...
<!-- Modal Edit Other Records Form End-->
