...
<div class="modal fade" id="addOtherModal" tabindex="-1" role="dialog" aria-labelledby="addDrawingModal"
    aria-hidden="true">
    <div class="modal-dialog modal-lg" style="min-width:50%;" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="addDrawingModalLabel">Add Document</h5>
                        ...
                        <form class="user" action="{{ route('pmd.content.create') }}" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" id="content_path" name="content_path"
                                    value="Rail / Drawing / {{$records->otherRec_name}}" readonly>
                            </div>
                            ...
                            <input type="hidden" class="form-control" id="otherRec_id" name="otherRec_id"
                                    value="{{ $records->otherRec_id }}">
                            ...
                            <input type="hidden" class="form-control" id="content_category" name="content_category" value="Other Records">
