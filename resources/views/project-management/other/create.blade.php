<!-- Modal Create Other Records Form-->
<div class="modal fade" id="othersModal" tabindex="-1" role="dialog" aria-labelledby="demoModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" style="min-width:50%;" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="demoModalLabel">Create New Record</h5>
            ...
            <div class="modal-body">
                <div class="card shadow col-xl-12  mb-4">
                    <div class="card-body">
                        <form class="user" action="{{ route('pmd.storeOther') }}" method="POST"
                            ...
                            <div class="form-group">
                                ...
                                <textarea rows="5" class="form-control" id="otherRec_desc" name="otherRec_desc"></textarea>
                            </div>
...
<!-- Modal Create Other Records Form End-->
