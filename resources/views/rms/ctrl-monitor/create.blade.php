...
<div class="modal fade" id="addCtrlMntrModal" tabindex="-1" role="dialog" aria-labelledby="demoModalLabel"
    aria-hidden="true">
    <div class="modal-dialog modal-lg" style="min-width:50%;" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="demoModalLabel">Create New Control Monitoring</h5>
            ...
            <div class="modal-body">
                <div class="card shadow col-xl-12  mb-4">
                    <div class="card-body">
                        <form class="user" action="{{ route('rms.storeCtrlMonitor') }}" method="POST"
                            enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <label class="label">Control Monitoring Name</label>
                                <input type="text" class="form-control" id="ctrl_monitor_name"
                                    name="ctrl_monitor_name" required>
                            </div>
                            <br>
