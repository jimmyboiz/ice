        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="card shadow col-xl-12  mb-4">
                    <div class="card-body">
                        <form class="user" action="{{ route('grade.update', [$grade->grade_id]) }}" method="POST"
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <select class="form-control" id="is_active" name="is_active">
                                        @if ($grade->is_active === 'Y')
                                            <option value="{{ $grade->is_active }}" selected>Active</option>
                                            <option value="N">Inactive</option>
                                        @elseif ($grade->is_active === 'N')
                                            <option value="{{ $grade->is_active }}" selected>Inactive</option>
                            ...
                            <div class="form-group ">
                                ...
                                <input type="text" class="form-control" id="grade_desc" name="grade_desc"
                                    value="{{ $grade->grade_desc }}">
                            </div>
